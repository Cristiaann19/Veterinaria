...
('Antiparasitarios', 'Protección completa contra pulgas y garrapatas.', 35.00, 100, 'https://res.cloudinary.com/ddxdadxtr/image/upload/v1788636099/errdypfcylel82kxtamp.webp'),
('Alimento Premium', 'Nutrición balanceada adulto raza mediana.', 85.00, 50, 'https://res.cloudinary.com/ddxdadxtr/image/upload/v1788636106/vsyqew5shltybqiutbhi.jpg'),
('Shampoo Medicado', 'Tratamientos dermatológicos piel sensible.', 45.00, 30, 'https://res.cloudinary.com/ddxdadxtr/image/upload/v1788636113/nxzbru9v96j1uv034twj.webp'),
('Suplementos', 'Vitaminas y probióticos para cachorros.', 55.00, 40, 'https://res.cloudinary.com/ddxdadxtr/image/upload/v1788636125/u4nwopgo2ppwz5wuyzum.avif'),
('Primeros Auxilios', 'Kit de emergencia veterinaria.', 65.00, 20, 'https://res.cloudinary.com/ddxdadxtr/image/upload/v1788636135/vb6s6vb3lkvfylntnjhc.jpg'),
('Juguetes Dental', 'Juguetes limpieza dental resistente.', 25.00, 150, 'https://res.cloudinary.com/ddxdadxtr/image/upload/v1788636161/ub2yzumtuwyapnqm9lzh.jpg'),
('Collar Reflectivo', 'Collares para paseos nocturnos.', 15.00, 80, 'https://res.cloudinary.com/ddxdadxtr/image/upload/v1788636169/u1ulvfdnpedwstvficzy.jpg'),
('Snacks Saludables', 'Premios nutritivos sabor pollo.', 20.00, 200, 'https://res.cloudinary.com/ddxdadxtr/image/upload/v1788636176/fvi4bot5q79rtksalaza.jpg'),
('Bravecto 10-20kg', 'Pastilla masticable antipulgas 3 meses.', 120.00, 60, 'https://res.cloudinary.com/ddxdadxtr/image/upload/v1788636185/fggmgujuujzpxdaktt8t.jpg'),
('Nexgard Spectra', 'Antipulgas y desparasitante interno.', 65.00, 80, 'https://res.cloudinary.com/ddxdadxtr/image/upload/v1788636194/i5f1lfawg2l5i0yux4y2.webp'),
('Hills Science Diet', 'Alimento prescripción riñones k/d.', 150.00, 25, 'https://res.cloudinary.com/ddxdadxtr/image/upload/v1788636202/ocobxkpkedlfwkfikjqt.jpg'),
('Ricocan Cordero', 'Alimento nacional premium 15kg.', 95.00, 40, 'https://res.cloudinary.com/ddxdadxtr/image/upload/v1788636225/dwljfbrqpu3ytihswjpp.webp'),
('Arena para Gatos', 'Aglutinante aroma lavanda 10kg.', 30.00, 100, 'https://res.cloudinary.com/ddxdadxtr/image/upload/v1788636634/hqyyfaixdui3og84skbh.webp'),
('Rascador Torre', 'Árbol para gatos 3 niveles.', 180.00, 15, 'https://res.cloudinary.com/ddxdadxtr/image/upload/v1788636645/c2yz9ahjdnl2hzvqpebf.jpg'),
('Cama Ortopédica', 'Cama viscoelástica para perros mayores.', 200.00, 10, 'https://res.cloudinary.com/ddxdadxtr/image/upload/v1788636653/xok1m9qunytcqbgw0adj.jpg'),
('Pipeta Frontline', 'Antipulgas tópico gatos.', 35.00, 90, 'https://res.cloudinary.com/ddxdadxtr/image/upload/v1788636661/nedkd4va2et9azaajfrm.webp'),
('Flexi Muzzle', 'Bozal para paseos y transporte seguro.', 35.00, 10, 'https://res.cloudinary.com/ddxdadxtr/image/upload/v1788636720/xtfhia2f5plikp0ookvx.jpg');

-- CATEGORÍAS DE PRODUCTOS
INSERT INTO categorias (nombre, descripcion) VALUES
('Antiparasitarios', 'Productos contra pulgas, garrapatas y parásitos internos.'),
('Alimentos', 'Alimentos balanceados y de prescripción para mascotas.'),
('Higiene y Cuidado', 'Productos para la higiene, dermatología y limpieza.'),
('Suplementos', 'Vitaminas y probióticos para la salud de la mascota.'),
('Juguetes', 'Juguetes y accesorios de entretenimiento.'),
('Accesorios', 'Complementos para el día a día de la mascota.'),
('Snacks y Premios', 'Premios y snacks nutritivos.');

-- RELACIÓN PRODUCTO - CATEGORÍA
INSERT INTO producto_categoria (producto_id, categoria_id) VALUES
((SELECT id FROM productos WHERE nombre = 'Antiparasitarios'), (SELECT id FROM categorias WHERE nombre = 'Antiparasitarios')),
((SELECT id FROM productos WHERE nombre = 'Alimento Premium'), (SELECT id FROM categorias WHERE nombre = 'Alimentos')),
((SELECT id FROM productos WHERE nombre = 'Shampoo Medicado'), (SELECT id FROM categorias WHERE nombre = 'Higiene y Cuidado')),
((SELECT id FROM productos WHERE nombre = 'Suplementos'), (SELECT id FROM categorias WHERE nombre = 'Suplementos')),
((SELECT id FROM productos WHERE nombre = 'Primeros Auxilios'), (SELECT id FROM categorias WHERE nombre = 'Higiene y Cuidado')),
((SELECT id FROM productos WHERE nombre = 'Juguetes Dental'), (SELECT id FROM categorias WHERE nombre = 'Juguetes')),
((SELECT id FROM productos WHERE nombre = 'Collar Reflectivo'), (SELECT id FROM categorias WHERE nombre = 'Accesorios')),
((SELECT id FROM productos WHERE nombre = 'Snacks Saludables'), (SELECT id FROM categorias WHERE nombre = 'Snacks y Premios')),
((SELECT id FROM productos WHERE nombre = 'Bravecto 10-20kg'), (SELECT id FROM categorias WHERE nombre = 'Antiparasitarios')),
((SELECT id FROM productos WHERE nombre = 'Nexgard Spectra'), (SELECT id FROM categorias WHERE nombre = 'Antiparasitarios')),
((SELECT id FROM productos WHERE nombre = 'Hills Science Diet'), (SELECT id FROM categorias WHERE nombre = 'Alimentos')),
((SELECT id FROM productos WHERE nombre = 'Ricocan Cordero'), (SELECT id FROM categorias WHERE nombre = 'Alimentos')),
((SELECT id FROM productos WHERE nombre = 'Arena para Gatos'), (SELECT id FROM categorias WHERE nombre = 'Higiene y Cuidado')),
((SELECT id FROM productos WHERE nombre = 'Rascador Torre'), (SELECT id FROM categorias WHERE nombre = 'Juguetes')),
((SELECT id FROM productos WHERE nombre = 'Cama Ortopédica'), (SELECT id FROM categorias WHERE nombre = 'Accesorios')),
((SELECT id FROM productos WHERE nombre = 'Pipeta Frontline'), (SELECT id FROM categorias WHERE nombre = 'Antiparasitarios')),
((SELECT id FROM productos WHERE nombre = 'Bozal para Perro'),(SELECT id FROM categorias WHERE nombre = 'Accesorios'));
